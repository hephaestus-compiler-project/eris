        ...
        if self._seeds_list is not None:
            ...
            program = ut.load_program(
                os.path.join(self._seeds_dir, seed_dirname,
                             filename + ".bin"))
            # The generator's context must reflect the loaded program;
            # several synthesis paths (e.g., SAM checks) consult it.
    ...
    def _gen_func_ref(self, etype: tp.Type,
        ...
        for func in funcs:
            ...
            refs.append(ast.FunctionReference(
                func.attr_decl.name, func.receiver_expr, etype, etype))
        ...
        if type_fun:
            ...
            ref = ast.FunctionReference(
                type_fun.attr_decl.name, receiver, etype, etype)
